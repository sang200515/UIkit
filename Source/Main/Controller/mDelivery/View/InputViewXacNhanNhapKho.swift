//
//  InputViewXacNhanNhapKho.swift
//  NewmDelivery
//
//  Created by sumi on 4/19/18.
...
class InputViewXacNhanNhapKho: UIView {

    var inputViewXacNhanNhapKhoDelegate:InputViewXacNhanNhapKhoDelegate!
    ...
    override init(frame: CGRect) {
        ...
        let textTitle = "Xác nhận nhập kho"
    ...
    @objc func clickAdd()
    {
        ...
        {
            inputViewXacNhanNhapKhoDelegate?.didClose(sender:
    ...
    {
        inputViewXacNhanNhapKhoDelegate?.didCancel(sender:
            self)
    }
...
protocol InputViewXacNhanNhapKhoDelegate
{
...
extension InputViewXacNhanNhapKho: InputViewXacNhanNhapKhoDelegate
{
