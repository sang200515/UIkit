//
//  InputTextViewTraHang.swift
//  NewmDelivery
//
//  Created by sumi on 4/5/18.
...
class InputTextViewTraHang: UIView {
    
    var inputTextViewTraHangDelegate:InputTextViewTraHangDelegate!
    ...
    override init(frame: CGRect) {
        ...
        btnAdd.addTarget(self, action: #selector(InputTextViewTraHang.clickAdd), for: UIControl.Event.touchDown)
        
        
        btnClose.addTarget(self, action: #selector(InputTextViewTraHang.ClickClose), for: UIControl.Event.touchDown)
    ...
    @objc func clickAdd()
    {
        ...
        {
            inputTextViewTraHangDelegate?.didClose(sender:
                self,mString:"\(edtNameProduct.text!)")
        }
        else
        {
    ...
    {
        inputTextViewTraHangDelegate?.didCancel(sender:
            self)
    }
...
protocol InputTextViewTraHangDelegate
{
...
extension InputTextViewTraHang: InputTextViewTraHangDelegate
{
