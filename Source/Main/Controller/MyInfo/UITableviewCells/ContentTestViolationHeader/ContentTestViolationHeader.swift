//
//  ContentTestViolationHeader.swift
//  fptshop
//
...
protocol HeaderContentTestViolationViewDelegate {
    func toggleSection(header: HeaderContentTestViolationView, section: Int)
}

class HeaderContentTestViolationView: UITableViewHeaderFooterView {
    var delegate: HeaderContentTestViolationViewDelegate?
    var section: Int!
    var isRotate: Bool?
    ...
    func customInit(title: String, section: Int, delegate: HeaderContentTestViolationViewDelegate) {
