...
class ReportCollectionViewLayout: UICollectionViewLayout {
    ...
    override func prepare() {
        ...
        if collectionView.numberOfSections > 0 {
            for section in 0..<collectionView.numberOfSections {
                ...
                } else if collectionView.numberOfItems(inSection: section) == 1 {
                    let attributes = layoutAttributesForItem(at: IndexPath(item: 0, section: section))
                ...
                } else if collectionView.numberOfItems(inSection: section) <= 0 {
                    return
                }
            }
        } else {
...
// MARK: - Helpers
extension ReportCollectionViewLayout {
