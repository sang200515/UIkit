//
//  KhaiThacMayKemPKViewController.swift
//  fptshop
//
...
class KhaiThacMayKemPKViewController: UIViewController, MFMailComposeViewControllerDelegate, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.title = "BC khai thác máy kèm PK"
        self.listKTMayKemPK.removeAll()
        self.header = ["Vùng", "ASM", "Tên Shop", "SL Máy", "SL SDP", "Tỷ lệ KT", "SL MDMH", "Tỷ lệ KT", "SL Ốp lưng", "Tỷ lệ KT"]
        self.getData()
    }
    ...
    func getData() {
        ...
        WaitingNetworkResponseAlert.PresentWaitingAlert(parentVC: self) {
            self.listKTMayKemPK = mSMApiManager.msm_KhaiThacMayKemPK().Data ?? []
    ...
    @objc func ExportFile() {
        let path = NSTemporaryDirectory() + "BCKhaiThacMayKemPK.csv"
        ...
        do {
            if #available(iOS 15.2, *) {
                let filName = "BCKhaiThacMayKemPK.csv"
                ...
                let action = UIAlertAction(title: "OK", style: .default) { (_) in
                    ...
                    if( MFMailComposeViewController.canSendMail() ) {
                        ...
                        self.mailComposer.setSubject("mSM - BCKhaiThacMayKemPK \(currentDateString)")
                        self.mailComposer.setMessageBody("BCKhaiThacMayKemPK xuat tu ung dung mSM ngay \(currentDateString)", isHTML: false)
...
extension KhaiThacMayKemPKViewController: UICollectionViewDelegate, UICollectionViewDataSource {
