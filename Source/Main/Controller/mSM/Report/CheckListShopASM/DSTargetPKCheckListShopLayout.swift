//
//  DSTargetPKCheckListShopLayout.swift
//  fptshop
//
...
class DSTargetPKCheckListShopLayout: UICollectionViewLayout {
...
// MARK: - Helpers
extension DSTargetPKCheckListShopLayout {
    ...
    func sizeForItemWithColumnIndex(_ columnIndex: Int) -> CGSize {
        ...
        return CGSize(width: (collectionView?.frame.width)!/3, height: 25);
