//
//  CheckListShopASMCollectionViewLayout.swift
//  fptshop
//
...
class CheckListShopASMCollectionViewLayout: UICollectionViewLayout {
...
// MARK: - Helpers
extension CheckListShopASMCollectionViewLayout {
...
//        let size: CGSize = text.size(withAttributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 10)]);
        if columnIndex == 0 {
            ...
            width = (collectionView?.frame.width)! - 100
        }
