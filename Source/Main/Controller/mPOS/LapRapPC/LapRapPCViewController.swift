...
class LapRapPCViewController: UIViewController {
...
//        loadSearchItems(shopCode: "30808", status: "", from: Common.gettimeWith(format: "dd/MM/yyyy"), to: Common.gettimeWith(format: "dd/MM/yyyy"), itemcode: "")Cache .user!.shopCode
    ...
    func configureUI() {
        ...
        tableView.register(UINib(nibName: "LaprapPCCell", bundle: nil), forCellReuseIdentifier: "LaprapPCCell")
    }
...
extension LapRapPCViewController: UISearchBarDelegate {
...
extension LapRapPCViewController: UITableViewDelegate,UITableViewDataSource  {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "LaprapPCCell", for: indexPath) as! LaprapPCCell
