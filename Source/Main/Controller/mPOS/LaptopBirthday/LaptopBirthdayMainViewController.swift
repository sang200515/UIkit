//
//  LaptopBirthdayMainViewController.swift
//  fptshop
//
...
class LaptopBirthdayMainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        self.title = "LAPTOP-CHƯƠNG TRÌNH SINH NHẬT"
    ...
    func configureUI(){
        ...
        let crmItem1 = ItemApp(id: "101", name: "Laptop - chương trình sinh nhật", type: "1", icon: #imageLiteral(resourceName: "Layer 32 3"))
        items.append(crmItem1)
        let crmItem2 = ItemApp(id: "102", name: "Lịch sử", type: "2", icon: #imageLiteral(resourceName: "LSLaptopBirthday"))
...
extension LaptopBirthdayMainViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if(item.type == "1"){
            let controller = DetailInfoLaptopBirthdayViewController()
            navigationController?.pushViewController(controller, animated: true)
        }else if(item.type == "2"){
            let controller = HistoryLapTopBirthdayViewController()
            navigationController?.pushViewController(controller, animated: true)
        }
