//
//  RelateProfileCustomer.swift
//  QuickCode
//
//  Created by Sang Trương on 13/07/2022.
//
import UIKit
class RelateProfileCustomer: UIViewController {
        //MARK: - Variable
    ...
    private func setupUI() {
        ...
        tfName.withImage(direction: .left, image: UIImage(named: "ic_credit_card")!)
        tfPhone.withImage(direction: .left, image: UIImage(named: "ic_calendar")!)
        tfDate.withImage(direction: .left, image: UIImage(named: "ic_map2")!)
...
extension RelateProfileCustomer: UITextFieldDelegate {
