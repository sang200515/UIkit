...
protocol CreateCustomerProtocol {
    ...
    func searchCustomerByIDCard(id: String, success: @escaping SuccessHandler<CreateCustomerModel>.object, failure: @escaping RequestFailure)
}
...
class CreateCustomerAPIService: CreateCustomerProtocol {
    ...
    func searchCustomerByIDCard(id: String, success: @escaping SuccessHandler<CreateCustomerModel>.object, failure: @escaping RequestFailure) {
        let endPoint = CreteCustomerEndpoint.searchCustomerByIDCard(id: id)
        network.requestData(endPoint: endPoint, success: MapperData.mapObject(success), failure: failure)
    }
}
