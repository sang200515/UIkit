...
import UIKit
class EditCustomerInfo: UIViewController {
        //MARK: - Variable
    ...
    @IBOutlet weak var tfAddressDefault: UITextField!
    @IBOutlet weak var tfAddress: UITextField!
    @IBOutlet weak var tfCMND: UITextField!
    @IBOutlet weak var tfDateOnCMND: UITextField!
    @IBOutlet weak var tfAddressOnCMND: UITextField!
    ...
    private func setupUI() {
        ...
        tfAddressDefault.withImage(direction: .left, image: UIImage(named: "ic_map")!)
        tfAddress.withImage(direction: .left, image: UIImage(named: "ic_map2")!)
        tfCMND.withImage(direction: .left, image: UIImage(named: "ic_credit_card")!)
        tfDateOnCMND.withImage(direction: .left, image: UIImage(named: "ic_calendar")!)
        tfAddressOnCMND.withImage(direction: .left, image: UIImage(named: "ic_map2")!)
...
extension EditCustomerInfo: UITextFieldDelegate {
