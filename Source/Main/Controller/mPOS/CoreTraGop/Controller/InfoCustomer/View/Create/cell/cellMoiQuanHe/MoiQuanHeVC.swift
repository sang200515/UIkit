...
extension MoiQuanHeVC: UITableViewDataSource, UITableViewDelegate {
	...
	func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if flow == "create" {
            ...
            switch index {
                case 0:
                    CoreInstallMentData.shared.editItemListNguoiLienHe[0]["relationshipName"] = listMQH[indexPath.row].name ?? ""
                    CoreInstallMentData.shared.editItemListNguoiLienHe[0]["relationshipCode"] = listMQH[indexPath.row].code ?? ""

                case 1:
                    CoreInstallMentData.shared.editItemListNguoiLienHe[1]["relationshipName"] = listMQH[indexPath.row].name ?? ""
                    CoreInstallMentData.shared.editItemListNguoiLienHe[1]["relationshipCode"] = listMQH[indexPath.row].code ?? ""
