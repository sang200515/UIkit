    ...
    func bindCell(item:[String:Any],index:Int,controller:UIViewController,flow:String) {
        ...
        switch flow {
            case "create":
                ...
                if CoreInstallMentData.shared.isCreateNguoiLienHe{
                    tfName.text = CoreInstallMentData.shared.listNguoiLienHe[index]["fullName"] as? String ?? ""
                    tfRalationShip.text = CoreInstallMentData.shared.listNguoiLienHe[index]["relationshipName"] as? String ?? ""
                    tfPhone.text = CoreInstallMentData.shared.listNguoiLienHe[index]["phone"] as? String ?? ""
                }
            case "edit":
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        switch flow {
            ...
            case "edit":
                if textField == tfName {
                    print(textField.text ?? "")
                    CoreInstallMentData.shared.editItemListNguoiLienHe[index]["fullName"] = textField.text ?? ""
                }

                if textField == tfRalationShip {
                    print(textField.text ?? "")
                    CoreInstallMentData.shared.editItemListNguoiLienHe[index]["relationshipName"] = textField.text ?? ""

                }
                if textField == tfPhone {
                    print(textField.text ?? "")
                    CoreInstallMentData.shared.editItemListNguoiLienHe[index]["phone"] = textField.text ?? ""
                }
            default :
                return
        }
