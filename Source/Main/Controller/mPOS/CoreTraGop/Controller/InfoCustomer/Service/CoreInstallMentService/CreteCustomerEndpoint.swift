...
enum CreteCustomerEndpoint {
    ...
    case searchCustomerByIDCard(id: String)
...
extension CreteCustomerEndpoint: EndPointType {
    ...
    var httpMethod: HTTPMethod {
        switch self {
            case .createCustomerCoreInstallment:
                return .post
            case .loadInfoCustomer,.searchInfoCustomer,.searchCustomerByIDCard:
                return .get
    ...
    var path: String {
        ...
        switch self {
            case .createCustomerCoreInstallment:
                return BASE_URL + "/api/customer"
            case .editCustomerCoreInstallment:
                return BASE_URL + "/api/customer/\(CoreInstallMentData.shared.editID)"
            case .loadInfoCustomer:
                return BASE_URL + "/api/customer/\(CoreInstallMentData.shared.editID)"
            case .searchInfoCustomer(let keyword,let skipCount,let maxResultCount):
                return BASE_URL + "/api/customer?keyword=\(keyword)&skipCount=\(skipCount)&maxResultCount=\(maxResultCount)"
            case .deleteInfoCustomer:
                return BASE_URL + "/api/customer?id=\(CoreInstallMentData.shared.editID)"
            case .searchCustomerByIDCard(let id):
                return BASE_URL + "/api/customer/search?idCard=\(id)"
        }
    }
