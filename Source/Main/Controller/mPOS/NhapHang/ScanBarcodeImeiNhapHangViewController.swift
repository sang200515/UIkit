...
protocol ScanBarcodeImeiNhapHangViewControllerDelegate: NSObjectProtocol {
    
    func scanSuccessVoucher(_ viewController: ScanBarcodeImeiNhapHangViewController, scan: String)
    
}

class ScanBarcodeImeiNhapHangViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    
    weak var delegate: ScanBarcodeImeiNhapHangViewControllerDelegate?
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationItem.title = "Quét mã vạch"
        success = false
        ...
        do {
            ...
            //            borderLayer.path = UIBezierPath(roundedRect: CGRect(x: Common.Size(s: 20), y: UIScreen.main.bounds.size.height/2 - Common.Size(s: 40), width: UIScreen.main.bounds.size.width - Common.Size(s: 40), height: Common.Size(s: 120)), cornerRadius: 10).cgPath
            ...
            //            borderLayer.shadowPath = UIBezierPath(rect: view.layer.bounds).cgPath
    ...
    func captureOutput(_ captureOutput: AVCaptureOutput!, didOutputMetadataObjects metadataObjects: [Any]!, from connection: AVCaptureConnection!) {
        ...
        if supportedCodeTypes.contains(metadataObj.type) {
            ...
            if metadataObj.stringValue != nil {
                ...
                if (success == false){
                    delegate?.scanSuccessVoucher(self, scan: metadataObj.stringValue!)
                    success = true
                }
            }
        }
