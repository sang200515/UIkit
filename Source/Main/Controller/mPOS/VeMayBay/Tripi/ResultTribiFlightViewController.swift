...
import UIKit
import PopupDialog
class ResultTribiFlightViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        btLeftIcon.addTarget(self, action: #selector(ResultTribiFlightViewController.backButton), for: UIControl.Event.touchUpInside)
        ...
        let jsonOutbound = self.convertToDictionary(text: self.detailTribi!.outbound)
        ...
        let lbHangBayDi = UILabel(frame: CGRect(x: Common.Size(s: 15), y: lbDenBayDi.frame.origin.y + lbDenBayDi.frame.size.height + Common.Size(s: 10), width: self.view.frame.width - Common.Size(s: 30), height: Common.Size(s: 15)))
        ...
        let lbHangBayVe = UILabel(frame: CGRect(x: Common.Size(s: 15), y: lbDenValueBayVe.frame.origin.y + lbDenBayDi.frame.size.height + Common.Size(s: 10), width: self.view.frame.width - Common.Size(s: 30), height: Common.Size(s: 15)))
                     ...
                     if let jsonArray = try JSONSerialization.jsonObject(with: data, options : .allowFragments) as? [Dictionary<String,Any>]
                     {
                         ...
                         for item in jsonArray{
                            ...
                            viewRow.addSubview(lbNgaySinhValueTTHK)
                             ...
                             //                        let lbNgayDiTTHK = UILabel(frame: CGRect(x: Common.Size(s: 15), y:  lbGenderTTHK.frame.size.height + lbGenderTTHK.frame.origin.y + Common.Size(s: 10), width: self.view.frame.width - Common.Size(s: 30), height: Common.Size(s: 15)))
                             //                        lbNgayDiTTHK.text = "Ngày đi"
                             //                        lbNgayDiTTHK.font = UIFont.systemFont(ofSize: Common.Size(s: 13))
                             //                        viewRow.addSubview(lbNgayDiTTHK)
                             //
                             //                        let lbNgayDiTTHKValue = UILabel(frame: CGRect(x:0, y: lbNgayDiTTHK.frame.origin.y, width: self.view.frame.width - Common.Size(s: 30), height: Common.Size(s: 15)))
                             //
                             //                        lbNgayDiTTHKValue.textAlignment = .right
                             //                        lbNgayDiTTHKValue.textColor = .black
                             //                        lbNgayDiTTHKValue.font = UIFont.systemFont(ofSize: Common.Size(s: 13))
                             //                        if(item["fromDate"] != nil){
                             //                            lbNgayDiTTHKValue.text = (item["fromDate"] as! String)
                             //                        }
                             //
                             //                        viewRow.addSubview(lbNgayDiTTHKValue)
                             //
                             //
                             //                        let lbNgayVeTTHK = UILabel(frame: CGRect(x: Common.Size(s: 15), y:  lbNgayDiTTHK.frame.size.height + lbNgayDiTTHK.frame.origin.y + Common.Size(s: 10), width: self.view.frame.width - Common.Size(s: 30), height: Common.Size(s: 15)))
                             //                        lbNgayVeTTHK.text = "Ngày về"
                             //                        lbNgayVeTTHK.font = UIFont.systemFont(ofSize: Common.Size(s: 13))
                             //                        viewRow.addSubview(lbNgayVeTTHK)
                             //
                             //                        let lbNgayVeTTHKValue = UILabel(frame: CGRect(x:0, y: lbNgayVeTTHK.frame.origin.y, width: self.view.frame.width - Common.Size(s: 30), height: Common.Size(s: 15)))
                             //
                             //                        lbNgayVeTTHKValue.textAlignment = .right
                             //                        lbNgayVeTTHKValue.textColor = .black
                             //                        lbNgayVeTTHKValue.font = UIFont.systemFont(ofSize: Common.Size(s: 13))
                             //                        if(item["toDate"] != nil){
                             //                            lbNgayVeTTHKValue.text = (item["toDate"] as! String)
                             //                        }
                             
                             //viewTTHK.addSubview(lbNgayVeTTHKValue)
                        ...
                        let lblNote = UILabel(frame: CGRect(x: Common.Size(s: 15), y:  viewTTHK.frame.size.height + viewTTHK.frame.origin.y + Common.Size(s: 10), width: self.view.frame.width - Common.Size(s: 30), height: Common.Size(s: 30)))
                        lblNote.text = "Shop vui lòng thu tiền KH trước khi bấm xác nhận"
