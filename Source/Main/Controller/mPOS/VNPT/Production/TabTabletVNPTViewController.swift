...
import Foundation
import Kingfisher
class TabTabletVNPTViewController: UIViewController,UICollectionViewDelegateFlowLayout, UICollectionViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        ProductAPIManager.product_filter(u_ng_code:"01",item_group_code:"108",sort_point:"0",price:lstDict[0],firm_code:"", pagination: lstDictPagination[0]) { [weak self](results, err) in
