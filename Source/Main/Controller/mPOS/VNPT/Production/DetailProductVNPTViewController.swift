...
class DetailProductVNPTViewController: UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        btBackIcon.addTarget(self, action: #selector(DetailProductVNPTViewController.actionBack), for: UIControl.Event.touchUpInside)
        ...
        btRightIcon.addTarget(self, action: #selector(DetailProductVNPTViewController.actionHome), for: UIControl.Event.touchUpInside)
        ...
        btCartIcon.addTarget(self, action: #selector(DetailProductVNPTViewController.actionCart), for: UIControl.Event.touchUpInside)
        ...
        sku = Cache.sku
        self.delegate = self
        let tabProduct = TabProductVNPTViewController()
        ...
        // Create Tab two
        let tabSameProduct = TabSameProductVNPTViewController()
        ...
        self.viewControllers = [tabProduct, tabSameProduct,tabCompare]
