...
import Toaster
class DetailAccessoriesVNPTViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        btRightIcon.addTarget(self, action: #selector(DetailAccessoriesVNPTViewController.actionHome), for: UIControl.Event.touchUpInside)
        ...
        btCartIcon.addTarget(self, action: #selector(DetailAccessoriesVNPTViewController.actionCart), for: UIControl.Event.touchUpInside)
    ...
    func loadProduct(product:ProductBySku) {
        ...
        let tap2 = UITapGestureRecognizer(target: self, action: #selector(DetailAccessoriesVNPTViewController.tapShowCheckInStock))
