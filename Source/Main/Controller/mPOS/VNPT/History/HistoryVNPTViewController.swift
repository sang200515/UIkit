...
import PopupDialog
class HistoryVNPTViewController: UIViewController,UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        btLeftIcon.addTarget(self, action: #selector(HistoryVNPTViewController.backButton), for: UIControl.Event.touchUpInside)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        MPOSAPIManager.mpos_FRT_SP_VNPT_load_history(keyword: "", handler: { (results, err) in
            if(results.count > 0){
    ...
    func setupUI(list: [HistoryVNPT]){
        ...
        tableView.register(SearchItemSOHistoryVNPTTableViewCell.self, forCellReuseIdentifier: "SearchItemSOHistoryVNPTTableViewCell")
...
extension HistoryVNPTViewController: UISearchBarDelegate {
...
extension HistoryVNPTViewController: UISearchResultsUpdating {
...
class SearchItemSOHistoryVNPTTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        cmnd = UILabel()
        cmnd.textColor = UIColor.red
        cmnd.numberOfLines = 0
        cmnd.font = UIFont.boldSystemFont(ofSize: 13)
    ...
    func setup(so:HistoryVNPT){
        ...
        ngaymua.text = "Ngày mua: \(so.NgayMua)"
