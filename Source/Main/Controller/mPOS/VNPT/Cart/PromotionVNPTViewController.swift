...
class PromotionVNPTViewController: UIViewController,UITableViewDelegate, UITableViewDataSource, ChangePromotionViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.promotions = Cache.promotionsVNPT
        self.group = Cache.groupVNPT
        ...
        Cache.resultPromostionsVNPT.removeAll()
        Cache.resultPromostionsVNPT.append(contentsOf: list)
        self.setupUI()
    }
    ...
    func setupUI(){
        ...
        tableView.register(ItemGiftVNPTTableViewCellV2.self, forCellReuseIdentifier: "ItemGiftVNPTTableViewCellV2")
        ...
        if groupChoose.count > 0 || notPromotionValue{
            for item in self.result{
                if(item.group == groupChoose){
                    ...
                    for itm in item.promotions!{
                        Cache.itemsPromotionVNPT.append(itm.promotionsMain)
                    }
                    break
                }
            }
            ...
            newViewController.carts = Cache.cartsTempVNPT
            newViewController.itemsPromotion = Cache.itemsPromotionTempVNPT
...
class ItemGiftVNPTTableViewCellV2: UITableViewCell {
...
extension PromotionVNPTViewController : FZAccordionTableViewDelegate {
