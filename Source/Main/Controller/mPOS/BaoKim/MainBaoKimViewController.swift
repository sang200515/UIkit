//
//  MainBaoKimViewController.swift
//  fptshop
//
//  Created by Doan Minh Hoang on 11/11/2021.
//  Copyright © 2021 FPT DIGITAL RETAIL JOINT STOCK COMPANY. All rights reserved.
//

import UIKit

class MainBaoKimViewController: UIViewController {

    var collectionView: UICollectionView!
    var btnBack: UIBarButtonItem!
    var collectionViewHeightConstraint = NSLayoutConstraint()
    
    var carList: [ItemAppThuHoService] = []
    ...
    func initData() {
        let sell = ItemAppThuHoService(id: "0", name: "Bán vé", type: "999", icon: #imageLiteral(resourceName: "Vé xemáybay"), item: ThuHoService(PaymentBillServiceName: "Bán vé", ListProvider: []))
        let history = ItemAppThuHoService(id: "1", name: "Lịch sử", type: "999", icon: #imageLiteral(resourceName: "GalaxyPay-History"), item: ThuHoService(PaymentBillServiceName: "Lịch sử", ListProvider: []))
        carList.append(sell)
        carList.append(history)
    }
...
extension MainBaoKimViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if item.id == "0" {
            ...
            let vc = HistoryBaoKimViewController()
            self.navigationController?.pushViewController(vc, animated: true)
        }
    }
