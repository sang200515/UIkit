//
//  FtelAddCardViewController.swift
//  fptshop
//
...
class FtelAddCardViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        tfCard.rightViewMode = .always
        tfCard.rightView = arrowImgView1
        ...
        tfCardType.rightViewMode = .always
        tfCardType.rightView = arrowImgView2
...
extension FtelAddCardViewController: UITextFieldDelegate {
