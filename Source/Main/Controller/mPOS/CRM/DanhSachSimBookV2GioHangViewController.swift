//
//  DanhSachSimBookV2GioHangViewController.swift
//  fptshop
//
...
import UIKit
import PopupDialog
class DanhSachSimBookV2GioHangViewController: UIViewController,UITextFieldDelegate,UITableViewDataSource, UITableViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        btLeftIcon.addTarget(self, action: #selector(DanhSachSimBookV2GioHangViewController.backButton), for: UIControl.Event.touchUpInside)
    ...
    func setupUI(list: [SimBookByShopV2]){
        ...
        searchTextFeild.placeholder = "Nhập số điện thoại/Ecom"
        ...
        viewTableListSim.register(ItemSimBookByShopV2GioHangTableViewCell.self, forCellReuseIdentifier: "ItemSimBookByShopV2GioHangTableViewCell")
    ...
    {
        let cell = ItemSimBookByShopV2GioHangTableViewCell(style: UITableViewCell.CellStyle.default, reuseIdentifier: "ItemSimBookByShopV2GioHangTableViewCell")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        if item.Provider.lowercased() == "viettel" || item.Provider.lowercased() == "mobifone"{
            ...
            return
        }else if item.Provider.lowercased() == "vinaphone" {
			//luong giỏ hàng
			let buttonOne = CancelButton(title: "Book sim") {
...
class ItemSimBookByShopV2GioHangTableViewCell: UITableViewCell {
    ...
    func setup(so:SimBookByShopV2){
        ...
        if(so.type == 1){
            ...
            tenGoiCuoc.frame = CGRect(x: Common.Size(s:10),y: sothuebao.frame.origin.y + sothuebao.frame.size.height + Common.Size(s:10) ,width: UIScreen.main.bounds.size.width - Common.Size(s: 5) ,height: Common.Size(s:30))
            ...
            sompos.frame = CGRect(x: Common.Size(s:10),y: sothuebao.frame.origin.y + sothuebao.frame.size.height + Common.Size(s:10) ,width: UIScreen.main.bounds.size.width - Common.Size(s: 5) ,height: Common.Size(s:16))
            if(so.SoMpos < 0){
