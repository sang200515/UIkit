...
protocol LoaiTheThanhToanGrabViewControllerDelegate: NSObjectProtocol {
    func returnService(item:CardTypeFromPOSResult,ind:Int)
}

class LoaiTheThanhToanGrabViewController: UIViewController, UITableViewDataSource, UITableViewDelegate{
    
    var delegate:LoaiTheThanhToanGrabViewControllerDelegate?
    var barClose : UIBarButtonItem!
    
    var tableView: UITableView = UITableView()
     var items: [CardTypeFromPOSResult] = []
    let searchController = UISearchController(searchResultsController: nil)
    var filteredCandies = [CardTypeFromPOSResult]()
    ...
    override func viewDidLoad() {
        ...
        btPlusIcon.addTarget(self, action: #selector(LoaiTheThanhToanGrabViewController.actionClose), for: UIControl.Event.touchUpInside)
        ...
        tableView.register(ItemLoaiTheCellView.self, forCellReuseIdentifier: "ItemLoaiTheCellView")
        ...
        newViewController.content = "Đang tải thông tin thẻ..."
        newViewController.modalPresentationStyle = UIModalPresentationStyle.overCurrentContext
        newViewController.modalTransitionStyle = UIModalTransitionStyle.crossDissolve
        self.navigationController?.present(newViewController, animated: true, completion: nil)
        let nc = NotificationCenter.default
        
        MPOSAPIManager.Get_CardType_From_POS() { (results, err) in
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell:ItemLoaiTheCellView = tableView.dequeueReusableCell(withIdentifier: "ItemLoaiTheCellView", for: indexPath) as! ItemLoaiTheCellView
        var candy: CardTypeFromPOSResult! = nil
        if isFiltering() {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        var item:CardTypeFromPOSResult! = nil
        if isFiltering() {
    ...
    func filterContentForSearchText(_ searchText: String, scope: String = "") {
        filteredCandies = items.filter({( candy : CardTypeFromPOSResult) -> Bool in
...
extension LoaiTheThanhToanGrabViewController: UISearchBarDelegate {
...
extension LoaiTheThanhToanGrabViewController: UISearchResultsUpdating {
...
class ItemLoaiTheCellView: UITableViewCell {
    var type: UILabel!
    var name: UILabel!
