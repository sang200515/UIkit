...
import Kingfisher
class TabPhoneViewController: UIViewController,UICollectionViewDelegateFlowLayout, UICollectionViewDataSource{
    ...
    let lstDictPrice:[Any] = ParamPriceFilter.convertParams(sortPriceFrom: 0,sortPriceTo: 0)
    ...
    override func viewDidLoad() {
        ...
        ProductAPIManager.product_filter(u_ng_code:"02",item_group_code:"111",sort_point:"0",price:lstDictPrice[0],firm_code:"", pagination: lstDictPagination[0]) {[weak self] (results, err) in
