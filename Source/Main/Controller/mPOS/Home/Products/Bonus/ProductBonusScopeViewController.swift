...
import AVFoundation
class ProductBonusScopeViewController: UITabBarController, UITabBarControllerDelegate,SearchDelegate,ActionHandleFilter {

    // MARK: - Properties
    
    private var btCartIcon:MIBadgeButton!
    ...
    override func viewDidLoad() {
        ...
        btBackIcon.addTarget(self, action: #selector(ProductBonusScopeViewController.actionBack), for: UIControl.Event.touchUpInside)
        ...
        let tabProduct = TabPhoneViewController()
        ...
        // Create Tab two
        let tabSameProduct = TabTabletViewController()
        ...
        let tabCompare = TabLaptopViewController()
        ...
        let tabApple = TabAppleViewController()
