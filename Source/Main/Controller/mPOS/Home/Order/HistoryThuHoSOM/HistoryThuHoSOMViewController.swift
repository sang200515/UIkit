//
//  HistoryThuHoSOMViewController.swift
//  fptshop
//
...
class HistoryThuHoSOMViewController: UIViewController {
   ...
   private func scrollToFirstRow() {
        ...
        self.tbvHistory.scrollToRow(at: indexPath as IndexPath, at: .top, animated: true)
    }
    ...
    private func loadData() {
        ...
        Provider.shared.thuhoSOMAPIService.getOrderHistory(term: term, fromDate: fromDate, toDate: toDate, success: { [weak self] result in
...
extension HistoryThuHoSOMViewController: UITextFieldDelegate {
...
extension HistoryThuHoSOMViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        Provider.shared.thuhoSOMAPIService.getOrderDetail(orderId: history.orderID, success: { [weak self] result in
			...
			if data.orderTransactionDtos[0].providerName == "EPAY"{
				vc.isEpay = true
			}
            vc.isHistory = true
