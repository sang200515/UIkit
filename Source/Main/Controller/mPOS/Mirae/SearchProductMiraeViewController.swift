//
//  SearchProductMiraeViewController.swift
//  fptshop
//
...
class SearchProductMiraeViewController: UITabBarController, UITabBarControllerDelegate,SearchDelegate {
    ...
    override func viewDidLoad() {
        ...
        let tabProduct = TabProductNewMiraeViewController()
        ...
        // Create Tab two
        let tabSameProduct = TabProductOldMiraeViewController()
