//
//  DetailAccessoriesMiraeViewController.swift
//  fptshop
//
...
class DetailAccessoriesMiraeViewController: UIViewController {
    // MARK: - Properties
    ...
    override func viewDidLoad() {
        ...
        btBackIcon.addTarget(self, action: #selector(DetailAccessoriesMiraeViewController.actionBack), for: UIControl.Event.touchUpInside)
        ...
        btCartIcon.addTarget(self, action: #selector(DetailAccessoriesMiraeViewController.actionCart), for: UIControl.Event.touchUpInside)
    ...
    @objc func handleShowPromos(){
        ...
        myVC.content = "<font size=\"4\">\(productBySku.product.promotion)</font>"
