//
//  DetailProductOldMiraeViewController.swift
//  fptshop
//
...
class DetailProductOldMiraeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        btBackIcon.addTarget(self, action: #selector(DetailProductOldMiraeViewController.actionBack), for: UIControl.Event.touchUpInside)
