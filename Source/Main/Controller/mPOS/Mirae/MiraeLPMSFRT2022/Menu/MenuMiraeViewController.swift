...
class MenuMiraeViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        self.configureNavigationBackItem(title: "TRẢ GÓP MIRAE")
        configureUI()
    }
    ...
    func configureUI(){
        ...
        let crmItem2 = ItemApp(id: "102", name: "Lịch sử", type: "2", icon: #imageLiteral(resourceName: "shinhan_history"))
...
extension MenuMiraeViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if item.type == "1" {
            let popup = PopUpMiraeLPMSViewController()
            popup.delegate = self
...
extension MenuMiraeViewController : PopUpMiraeLPMSViewControllerDelegate {
    func traGop(){
