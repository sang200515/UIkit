//
//  ThongTinDonHangCompleteInteractor.swift
//
...
class ThongTinDonHangMiraeCompleteInteractor:ThongTinDonHangMiraeCompletePresenterToInteractorProtocol {
    
    weak var presenter: ThongTinDonHangMiraeCompleteInteractorToPresenterProtocol?
