//
//  ThongTinDonHangCompleteView.swift
//  MireaKetNoiHeThong
//
...
class ThongTinDonHangMiraeCompleteView : UIView {
    ...
    lazy var luuDonHangButton:BaseButton = {
        ...
        button.setTitle("LƯU ĐƠN HÀNG", for: .normal)
        return button
    }()
    ...
    private func autoLayout(){
        ...
        self.thongTinVoucherLabel.snp.makeConstraints { make in
            ...
            make.leading.trailing.equalTo(self.thongTinDonHangLabel)
        }
