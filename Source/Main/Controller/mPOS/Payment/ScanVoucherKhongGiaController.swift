//
//  ScanVoucherKhongGiaController.swift
//  fptshop
//
...
protocol ScanVoucherKhongGiaControllerDelegate: NSObjectProtocol {
    
    func scanSuccessVoucher(_ viewController: ScanVoucherKhongGiaController, scan: String)
    
}

class ScanVoucherKhongGiaController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    weak var delegate: ScanVoucherKhongGiaControllerDelegate?
    ...
    override func viewDidLoad() {
        self.navigationItem.title = "Barcode Voucher"
        success = false
    ...
    func actionSelectVoucher(){
        ...
        delegate?.scanSuccessVoucher(self, scan: "SELECT_VOUCHER_KHONG_GIA")
    }
