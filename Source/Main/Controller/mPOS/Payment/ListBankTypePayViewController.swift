//
//  ListBankTypePayViewController.swift
//  fptshop
//
...
protocol ListBankTypePayViewControllerDelegate: NSObjectProtocol {
    func returnBankType(item:CardTypeFromPOSResult)
}

class ListBankTypePayViewController: UIViewController, UITableViewDataSource, UITableViewDelegate{
    
    var delegate:ListBankTypePayViewControllerDelegate?
    ...
    override func viewDidLoad() {
        ...
        btPlusIcon.addTarget(self, action: #selector(ListBankTypePayViewController.actionClose), for: UIControl.Event.touchUpInside)
        ...
        tableView.register(ItemBankTypePayCell.self, forCellReuseIdentifier: "ItemBankTypePayCell")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell:ItemBankTypePayCell = tableView.dequeueReusableCell(withIdentifier: "ItemBankTypePayCell", for: indexPath) as! ItemBankTypePayCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        delegate?.returnBankType(item:item)
    }
...
extension ListBankTypePayViewController: UISearchBarDelegate {
...
extension ListBankTypePayViewController: UISearchResultsUpdating {
    // MARK: - UISearchResultsUpdating Delegate
    func updateSearchResults(for searchController: UISearchController) {
        filterContentForSearchText(searchController.searchBar.text!, scope: "")
    }
}
class ItemBankTypePayCell: UITableViewCell {
    var type: UILabel!
    var name: UILabel!
