//
//  TabProductOldViewController.swift
//  fptshop
//
...
import UIKit
class TabProductOldViewController: UIViewController,UICollectionViewDelegateFlowLayout, UICollectionViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        MPOSAPIManager.getListOldProduct(shop: "\(Cache.user!.ShopCode)", skip: 0, top: 100, type: 0) { [weak self](results, err) in
