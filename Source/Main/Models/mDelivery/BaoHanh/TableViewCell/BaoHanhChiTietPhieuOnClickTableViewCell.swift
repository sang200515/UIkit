//
//  BaoHanhChiTietPhieuOnClickTableViewCell.swift
//  NewmDelivery
//
...
class BaoHanhChiTietPhieuOnClickTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        cellKHGiao = UILabel(frame: CGRect(x: 0, y: 0, width: UIScreen.main.bounds.size.width / 3 , height: Common.Size(s:100)))
        ...
        cellTenPhuKien = UILabel(frame: CGRect(x: cellKHGiao.frame.width, y: 0, width: UIScreen.main.bounds.size.width / 3, height: Common.Size(s:100)))
        ...
        cellSeriNo = UILabel(frame: CGRect(x: cellTenPhuKien.frame.size.width + cellTenPhuKien.frame.origin.x , y: 0, width: UIScreen.main.bounds.size.width - (cellKHGiao.frame.size.width + cellTenPhuKien.frame.size.width ) , height: Common.Size(s:100)))
