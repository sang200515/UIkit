...
class ThuHoProvider: NSObject {
    ...
    class func parseObjfromArray(array:[JSON])->[ThuHoProvider]{
        var list:[ThuHoProvider] = []
        for item in array {
    ...
    class func getObjFromDictionary(data:JSON) -> ThuHoProvider{
        ...
        return ThuHoProvider(PaymentBillProviderID: PaymentBillProviderID!, PaymentBillProviderCode : PaymentBillProviderCode!, PaymentBillProviderName: PaymentBillProviderName!, PaymentBillServiceID: PaymentBillServiceID!, PaymentBillServiceCode : PaymentBillServiceCode!, PaymentBillServiceName: PaymentBillServiceName!, PartnerUserCode: PartnerUserCode!, AgriBankProviderCode: AgriBankProviderCode!, AllowCardPayment: AllowCardPayment!, AllowCashPayment: AllowCashPayment!, AllowVoucherPayment: AllowVoucherPayment!, PaymentNote: PaymentNote!, SelectedComboTypeCard: SelectedComboTypeCard!)
    }
}
