...
class ViettelVASHistory: NSObject {
    ...
    class func getObjFromDictionary(data:JSON) -> ViettelVASHistory {
        ...
        return ViettelVASHistory( orderId: orderId,
                                     billNo: billNo,
                                     crmBillNo: crmBillNo,
    ...
    class func parseObjfromArray(array:[JSON])->[ViettelVASHistory]{
