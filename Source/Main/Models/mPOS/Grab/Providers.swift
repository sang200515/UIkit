...
class Providers: NSObject {
    ...
    init(  PaymentBillProviderID:String
    , PaymentBillProviderCode:String
    , PaymentBillProviderName:String
    , PaymentBillServiceID:String
    , PaymentBillServiceCode:String
    , PaymentBillServiceName:String
    , PartnerUserCode:String
    , AgriBankProviderCode:String
    , AllowCardPayment:String
    , AllowCashPayment:String
    , AllowVoucherPayment:String
    , PaymentNote:String
    , SelectedComboTypeCard:String){
    ...
    class func parseObjfromArray(array:[JSON])->[Providers]{
        var list:[Providers] = []
        for item in array {
    ...
    class func getObjFromDictionary(data:JSON) -> Providers{
        ...
        return Providers(PaymentBillProviderID: PaymentBillProviderID!,PaymentBillProviderCode:PaymentBillProviderCode!,PaymentBillProviderName:PaymentBillProviderName!,PaymentBillServiceID:PaymentBillServiceID!,PaymentBillServiceCode:PaymentBillServiceCode!,PaymentBillServiceName:PaymentBillServiceName!,PartnerUserCode:PartnerUserCode!,AgriBankProviderCode:AgriBankProviderCode!,AllowCardPayment:AllowCardPayment!,AllowCashPayment:AllowCashPayment!,AllowVoucherPayment:AllowVoucherPayment!,PaymentNote:PaymentNote!,SelectedComboTypeCard:SelectedComboTypeCard!)
    }
