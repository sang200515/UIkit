...
public extension RevealingSplashView {
     ...
     */
    func startAnimation(_ completion: SplashAnimatableCompletion? = nil,stop:Bool)
    {
        ...
        case .popAndZoomOut:
                playPopAnimation(completion, stop: stop)
    ...
    /**
     ...
     - parameter completion: completion
     */
    func playPopAnimation(_ completion: SplashAnimatableCompletion? = nil,stop:Bool)
    {
        if let imageView = self.imageView{
